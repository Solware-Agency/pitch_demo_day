...
/** Logos de los 4 laboratorios validados */
const LAB_LOGOS = [
	{
			...
			<div className="relative z-10 flex flex-col items-center w-full">
				<AnimatePresence mode="wait">
					...
					{phase === 0 && (
						...
						>
							<motion.h2
								className="text-white font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center mb-6 sm:mb-8"
								initial={{ opacity: 0 }}
								animate={{ opacity: 1 }}
							...
							<div className="flex flex-wrap justify-center gap-8 sm:gap-10 md:gap-12 max-w-4xl">
							{LAB_LOGOS.map((lab, i) => (
								<motion.div
									key={lab.name}
								...
								>
									<div className="w-28 h-28 sm:w-36 sm:h-36 md:w-40 md:h-40 lg:w-44 lg:h-44 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center p-3 overflow-hidden">
										<img
											src={lab.src}
											alt={lab.alt}
						...
						>
							...
							>
								<div className="flex items-center justify-center gap-3 sm:gap-4 flex-wrap">
									...
									<motion.span
										className="relative inline-block text-white/60 font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl"
										initial={{ opacity: 0 }}
										animate={{ opacity: 1 }}
									...
									<motion.span
										className="text-white font-black text-xl sm:text-2xl md:text-3xl lg:text-4xl inline-flex items-baseline gap-1"
										initial={{ opacity: 0 }}
										animate={{ opacity: 1 }}
									...
									<motion.span
										className="text-white font-black text-2xl sm:text-3xl md:text-4xl lg:text-5xl tabular-nums inline-flex items-baseline gap-0.5"
										initial={{ opacity: 0 }}
										animate={{ opacity: 1 }}
										transition={{ duration: 0.4, delay: 1.0 }}
									>
