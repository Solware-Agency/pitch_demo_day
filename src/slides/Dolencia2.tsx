			...
			<div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8">
				...
				>
					<AnimatedIcon delay={0.4}>
						<Heart className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 text-red-400 mb-3 sm:mb-4" />
					</AnimatedIcon>
					<AnimatedText delay={0.6}>
						<h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-white">Riesgo de Vida</h3>
					</AnimatedText>
				</AnimatedCard>
				...
				>
					...
					<AnimatedText delay={0.8}>
						<h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-white">Pérdida de Datos</h3>
					</AnimatedText>
				</AnimatedCard>
				...
				>
					<AnimatedIcon delay={0.8}>
						<Shield className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 text-yellow-400 mb-3 sm:mb-4" />
					</AnimatedIcon>
					<AnimatedText delay={1.0}>
						<h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-white">Riesgo Legal</h3>
					</AnimatedText>
				</AnimatedCard>
				...
				>
					<AnimatedIcon delay={1.0}>
						<Users className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 text-purple-400 mb-3 sm:mb-4" />
					</AnimatedIcon>
					<AnimatedText delay={1.2}>
						<h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-white">Impacto en el Personal</h3>
					</AnimatedText>
				</AnimatedCard>
			</div>
				...
				>
					<div className="flex flex-col sm:flex-row items-center justify-center mb-3 sm:mb-4">
						...
						<AnimatedText delay={2.0}>
							<h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white text-center">En Resumen</h3>
						</AnimatedText>
					</div>
					...
					<AnimatedText delay={2.4}>
						<div className="mt-4 flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4">
							<span className="text-orange-300 text-base sm:text-lg md:text-xl">❌ No hay copia</span>
							<span className="text-orange-300 text-base sm:text-lg md:text-xl">❌ No hay respaldo</span>
						</div>
					</AnimatedText>
				</AnimatedCard>
			</AnimatedText>
