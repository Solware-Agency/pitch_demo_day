	...
	return (
		<div className={`${slideBg.base} w-full flex flex-col items-center justify-center px-4 py-8 relative overflow-hidden min-h-dvh`}>
			...
			<div className="relative z-10 flex flex-col items-center justify-center w-full">
				...
				>
					<div className="rounded-xl overflow-hidden bg-white p-3 shadow-2xl flex-shrink-0">
						<Image
				...
				{/* Nombres */}
				<motion.p
					className="mt-8 text-white/80 text-center text-base sm:text-lg font-semibold"
